...
class ContactPagesControllerTest < ActionController::TestCase
  ...
  test "should create contact_page" do
    assert_difference('ContactPage.count') do
      post :create, contact_page: { email_address: @contact_page.email_address, first_name: @contact_page.first_name, last_name: @contact_page.last_name, message: @contact_page.message }
    end
  ...
  test "should update contact_page" do
    patch :update, id: @contact_page, contact_page: { email_address: @contact_page.email_address, first_name: @contact_page.first_name, last_name: @contact_page.last_name, message: @contact_page.message }
    assert_redirected_to contact_page_path(assigns(:contact_page))
  end

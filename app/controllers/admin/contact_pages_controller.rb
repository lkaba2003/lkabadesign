class Admin::ContactPagesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_contact_pages_url, notice: 'Contact page was successfully destroyed.' }
